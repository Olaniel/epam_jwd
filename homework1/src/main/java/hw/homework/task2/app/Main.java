package hw.homework.task2.app;

import hw.homework.task2.data.MonthInputValidator;
import hw.homework.task2.data.YearInputValidator;

import java.util.Scanner;

import static hw.homework.task2.data.DateProcessor.getDaysInMonth;
