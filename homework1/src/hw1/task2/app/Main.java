package hw1.task2.app;

import hw1.task2.data.MonthInputValidator;
import hw1.task2.data.YearInputValidator;

import java.util.Scanner;

import static hw1.task2.data.DateProcessor.getDaysInMonth;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The quantity of days in the chosen month is " + getDaysInMonth(month, year) + ".");
    }
