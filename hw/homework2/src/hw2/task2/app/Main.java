package hw2.task2.app;

import hw2.task2.data.MonthInputValidator;
import hw2.task2.data.YearInputValidator;

import java.util.Scanner;

import static hw2.task2.data.DateProcessor.getDaysInMonth;
